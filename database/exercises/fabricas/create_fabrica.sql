...
CREATE TABLE Fabricas (id SERIAL PRIMARY KEY, nome VARCHAR(100) NOT NULL, endereco VARCHAR(255) NOT NULL, telefone VARCHAR(20) NOT NULL);
...
CREATE TABLE Vendedores (id SERIAL PRIMARY KEY,nome VARCHAR(100) NOT NULL,concessionaria_id INT REFERENCES Concessionarias(id));
...
INSERT INTO Modelos (nome, descricao, potencia, quilometragem, preco_venda_sugerido, categoria) VALUES
    ...
    ('Chevrolet Bolt EV', 'Electric car with long range', 200, 259, 36999.99,'Hatchback');

INSERT INTO Carros (numero_serie, cor, ano_fabricacao, modelo_id, fabrica_id) VALUES
